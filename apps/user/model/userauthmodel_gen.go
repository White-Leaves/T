...
var (
	...
	cacheGomallUserUserAuthIdPrefix              = "cache:gomallUser:userAuth:id:"
	cacheGomallUserUserAuthAuthTypeAuthKeyPrefix = "cache:gomallUser:userAuth:authType:authKey:"
	cacheGomallUserUserAuthUserIdAuthTypePrefix  = "cache:gomallUser:userAuth:userId:authType:"
)
...
func (m *defaultUserAuthModel) Delete(ctx context.Context, id int64) error {
	...
	gomallUserUserAuthAuthTypeAuthKeyKey := fmt.Sprintf("%s%v:%v", cacheGomallUserUserAuthAuthTypeAuthKeyPrefix, data.AuthType, data.AuthKey)
	gomallUserUserAuthIdKey := fmt.Sprintf("%s%v", cacheGomallUserUserAuthIdPrefix, id)
	gomallUserUserAuthUserIdAuthTypeKey := fmt.Sprintf("%s%v:%v", cacheGomallUserUserAuthUserIdAuthTypePrefix, data.UserId, data.AuthType)
	_, err = m.ExecCtx(ctx, func(ctx context.Context, conn sqlx.SqlConn) (result sql.Result, err error) {
		query := fmt.Sprintf("delete from %s where `id` = ?", m.table)
		return conn.ExecCtx(ctx, query, id)
	}, gomallUserUserAuthAuthTypeAuthKeyKey, gomallUserUserAuthIdKey, gomallUserUserAuthUserIdAuthTypeKey)
	return err
}
...
func (m *defaultUserAuthModel) FindOne(ctx context.Context, id int64) (*UserAuth, error) {
	gomallUserUserAuthIdKey := fmt.Sprintf("%s%v", cacheGomallUserUserAuthIdPrefix, id)
	var resp UserAuth
	err := m.QueryRowCtx(ctx, &resp, gomallUserUserAuthIdKey, func(ctx context.Context, conn sqlx.SqlConn, v any) error {
...
func (m *defaultUserAuthModel) FindOneByAuthTypeAuthKey(ctx context.Context, authType string, authKey string) (*UserAuth, error) {
	gomallUserUserAuthAuthTypeAuthKeyKey := fmt.Sprintf("%s%v:%v", cacheGomallUserUserAuthAuthTypeAuthKeyPrefix, authType, authKey)
	var resp UserAuth
	err := m.QueryRowIndexCtx(ctx, &resp, gomallUserUserAuthAuthTypeAuthKeyKey, m.formatPrimary, func(ctx context.Context, conn sqlx.SqlConn, v any) (i any, e error) {
...
func (m *defaultUserAuthModel) FindOneByUserIdAuthType(ctx context.Context, userId int64, authType string) (*UserAuth, error) {
	gomallUserUserAuthUserIdAuthTypeKey := fmt.Sprintf("%s%v:%v", cacheGomallUserUserAuthUserIdAuthTypePrefix, userId, authType)
	var resp UserAuth
	err := m.QueryRowIndexCtx(ctx, &resp, gomallUserUserAuthUserIdAuthTypeKey, m.formatPrimary, func(ctx context.Context, conn sqlx.SqlConn, v any) (i any, e error) {
...
func (m *defaultUserAuthModel) Insert(ctx context.Context, data *UserAuth) (sql.Result, error) {
	gomallUserUserAuthAuthTypeAuthKeyKey := fmt.Sprintf("%s%v:%v", cacheGomallUserUserAuthAuthTypeAuthKeyPrefix, data.AuthType, data.AuthKey)
	gomallUserUserAuthIdKey := fmt.Sprintf("%s%v", cacheGomallUserUserAuthIdPrefix, data.Id)
	gomallUserUserAuthUserIdAuthTypeKey := fmt.Sprintf("%s%v:%v", cacheGomallUserUserAuthUserIdAuthTypePrefix, data.UserId, data.AuthType)
...
func (m *defaultUserAuthModel) formatPrimary(primary any) string {
	return fmt.Sprintf("%s%v", cacheGomallUserUserAuthIdPrefix, primary)
}
